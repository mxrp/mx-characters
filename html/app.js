          ...
          $("[data-charid=" + charid + "]")
            .html(
              '<h3 class="character-fullname">' +
                ...
                char.job +
                '</span></p><p class="character-info-money"><strong>Cash: </strong><span>' +
                char.money +
                '</span></p><p class="character-info-bank"><strong>Bank: </strong><span>' +
                char.bank +
                '</span></p> <p class="character-info-dateofbirth"><strong>Date of birth: </strong><span>' +
                char.dob +
                '</span></p> <p class="character-info-gender"><strong>Gender: </strong><span>' +
                char.sex +
                "</span></p></div>"
            )
